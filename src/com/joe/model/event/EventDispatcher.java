...
import com.joe.model.event.handler.ConsumeItemEventHandler;
...
import com.joe.model.event.handler.ItemOnItemEventHandler;
...
public class EventDispatcher {
	...
	static {
		...
		register(ConsumeItemEvent.class, new ConsumeItemEventHandler());
		register(ItemOnItemEvent.class, new ItemOnItemEventHandler());
	}
